...
import com.example.ipad.unix.model.SuperModel;
...
public class DataAccessProxy {
    ...
    private final String tag = "DataAccessProxy";

    /**
     * When you need to create a database file in sdcard, please use DBContext.
     */
    public DataAccessProxy(Context context, String name, int version) {
    ...
    public DataAccessProxy(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
        dbOpenHelper = new DBOpenHelper(context, name, factory, version, errorHandler);
    }
